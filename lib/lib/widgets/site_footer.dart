    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 1.h),
          Text('Punjab Education Schemes', style: GoogleFonts.montserrat(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 14.sp)),
          ...
          Text(
            ...
            style: TextStyle(color: Colors.white70, fontSize: 14.5.sp, height: 1.5),
          ),
          ...
          SizedBox(height: 1.2.h),
          Text('© 2026 Punjab Education Schemes. All rights reserved.', style: TextStyle(color: Colors.white38, fontSize: 12.sp)),
        ],
      ),
    );
  }
